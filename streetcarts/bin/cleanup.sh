...
curl -u $username:$password $url/v1/o/$org/developers/$proxy@sample.com/apps/$proxy-admin-app -X DELETE
...
curl -u $username:$password $url/v1/o/$org/apiproducts/$proxy-admin-product -X DELETE
